...
// Data
import { SIZES, type IProduct } from "@/api/data";
...
export function QuickView({ open = false, onClose, product }: IQuickViewProps): React.ReactElement {
  ...
  return (
    <Drawer placement="right" open={open} onClose={onClose} onEscape={onClose} onClickOutside={onClose}>
      <Drawer.Header>
